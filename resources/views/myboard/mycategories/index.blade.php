<x-app-layout>
    ...
    <x-slot name="header">
        ...
        <div class="flex items-center justify-end mt-4">
            <a href="{{ route('myboard.mycategories.create') }}">
                        ...
                        <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                            ...
                            <tbody>
                                ...
                                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                    ...
                                    <td class="px-6 py-4">
                                        <a href="{{ route('categories.show', $category) }}" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Show all Post in this category</a>
                                    </td>
                                    <td class="flex items-center px-6 py-4">
                                        <a href="{{ route('myboard.mycategories.edit', $category) }}" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Edit</a>
                                        <form action="{{ route('myboard.mycategories.destroy', $category) }}" method="POST" class="inline-block">
                                            @csrf
                                            @method('DELETE')
